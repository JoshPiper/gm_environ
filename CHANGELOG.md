...
## [0.5.0](https://github.com/JoshPiper/gm_environ/compare/v0.4.2...v0.5.0) - 2026-09-14
...
- say what to do when get_csv's values need commas ([#15](https://github.com/JoshPiper/gm_environ/pull/15))
...
* update gmod crate to 17. ([e0b4055](https://github.com/JoshPiper/gm_environ/commit/e0b40558e3b94cd9a0a3e958d7434ddc3b0c6448))
